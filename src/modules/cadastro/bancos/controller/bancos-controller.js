...
exports.listBancos = (req, res) => {

    model.Bancos.findAll({
        include: [
...
exports.saveBanco = async (req, res) => {
    ...
    try {
        transacao = await sequelize.transaction(async (t) => {
            ...
            //Salva na tabela
            await model.Bancos.create(dados, { transaction: t });           
...
exports.updateBanco = async (req, res) => {
    ...
    try {
        transacao = await sequelize.transaction(async (t) => {
            ...
            //Salva na tabela
            await model.Bancos.update(dados, {
                where: {
                    id: req.body.id
                }
            }, { transaction: t });           
...
exports.deleteBanco = async (req, res) => {
    ...
    try {
        transacao = await sequelize.transaction(async (t) => {
            ...
            //Deleta na tabela
            await model.Bancos.destroy({ where: { id: id } }, { transaction: t });
